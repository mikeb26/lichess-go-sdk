...
type NullableGameFullEventPerf struct {
	value *GameFullEventPerf
	isSet bool
}

func (v NullableGameFullEventPerf) Get() *GameFullEventPerf {
	return v.value
}

func (v *NullableGameFullEventPerf) Set(val *GameFullEventPerf) {
	v.value = val
	v.isSet = true
}
...
func NewNullableGameFullEventPerf(val *GameFullEventPerf) *NullableGameFullEventPerf {
	return &NullableGameFullEventPerf{value: val, isSet: true}
}
