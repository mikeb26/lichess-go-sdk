...
type NullableGameStartEvent struct {
	value *GameStartEvent
	isSet bool
}

func (v NullableGameStartEvent) Get() *GameStartEvent {
	return v.value
}

func (v *NullableGameStartEvent) Set(val *GameStartEvent) {
	v.value = val
	v.isSet = true
}
...
func NewNullableGameStartEvent(val *GameStartEvent) *NullableGameStartEvent {
	return &NullableGameStartEvent{value: val, isSet: true}
}
