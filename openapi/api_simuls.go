...
func (r ApiApiSimulRequest) Execute() ([]interface{}, *http.Response, error) {
	return r.ApiService.ApiSimulExecute(r)
}
...
*/
func (a *SimulsApiService) ApiSimul(ctx context.Context) ApiApiSimulRequest {
	return ApiApiSimulRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SimulsApiService) ApiSimulExecute(r ApiApiSimulRequest) ([]interface{}, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SimulsApiService.ApiSimul")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/simul"
