...
type NullableTeamRequestWithUser struct {
	value *TeamRequestWithUser
	isSet bool
}

func (v NullableTeamRequestWithUser) Get() *TeamRequestWithUser {
	return v.value
}

func (v *NullableTeamRequestWithUser) Set(val *TeamRequestWithUser) {
	v.value = val
	v.isSet = true
}

func (v NullableTeamRequestWithUser) IsSet() bool {
	return v.isSet
}
...
func NewNullableTeamRequestWithUser(val *TeamRequestWithUser) *NullableTeamRequestWithUser {
	return &NullableTeamRequestWithUser{value: val, isSet: true}
}
