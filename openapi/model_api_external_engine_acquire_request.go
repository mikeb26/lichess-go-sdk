...
func NewApiExternalEngineAcquireRequest() *ApiExternalEngineAcquireRequest {
	this := ApiExternalEngineAcquireRequest{}
	return &this
}
...
// GetProviderSecretOk returns a tuple with the ProviderSecret field value if set, nil otherwise
...
type NullableApiExternalEngineAcquireRequest struct {
	value *ApiExternalEngineAcquireRequest
	isSet bool
}

func (v NullableApiExternalEngineAcquireRequest) Get() *ApiExternalEngineAcquireRequest {
	return v.value
}

func (v *NullableApiExternalEngineAcquireRequest) Set(val *ApiExternalEngineAcquireRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableApiExternalEngineAcquireRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableApiExternalEngineAcquireRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiExternalEngineAcquireRequest(val *ApiExternalEngineAcquireRequest) *NullableApiExternalEngineAcquireRequest {
	return &NullableApiExternalEngineAcquireRequest{value: val, isSet: true}
}
